...
router.get("/", auth_middleware_1.authMiddleware, user_controller_1.getAllMentors);
// --- END OF FIX ---
...
router.get("/connections", auth_middleware_1.authMiddleware, user_controller_1.getUserConnections);
