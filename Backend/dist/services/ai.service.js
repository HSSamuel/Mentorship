 ...
 */
const findTopMentorMatches = (userId_1, ...args_1) => __awaiter(void 0, [userId_1, ...args_1], void 0, function* (userId, topN = 5) {
    ...
    const mentors = yield client_1.default.user.findMany({
        where: {
            id: { not: userId },
