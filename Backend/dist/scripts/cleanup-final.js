...
async function findAndRemoveOrphanedParticipants() {
    console.log("--- Starting final cleanup of orphaned SessionParticipant records ---");
    try {
        ...
        console.log(`Found ${allParticipants.length} participant records and ${validSessionIds.size} valid sessions.`);
        ...
        console.log(`🚨 Found ${orphanedParticipantIds.length} orphaned participant(s) to delete.`);
